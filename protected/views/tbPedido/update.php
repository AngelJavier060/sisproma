...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_Pedido) => array('view', 'id'=>$model->id_Pedido),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_Pedido)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TbPedido::label(); ?> <?php echo CHtml::encode($model) ?></legend>
    <?php echo $this->renderPartial('_form_modificar',array('model' => $model)); ?>
</fieldset>