...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_cliente) => array('view', 'id'=>$model->id_cliente),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_cliente)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TbCliente::label(); ?> <?php echo CHtml::encode($model) ?></legend>
