...
<!--           <h2>SISMEDANT</h2> -->
        ...
        <MARQUEE BGCOLOR="#555"><h1>GRACIAS <?php // YA NO EXISTE Yii::app()->getSession()->get('nombre_usuario')?> POR USAR SISMEDANT</h1></MARQUEE>
...
<!--        <a href="/sismedant/index.php/estudiante/create">
        ...
        <img src="/sismedant/images/pagina/Ficha.png" onmouseover="this.src='/sismedant/images/pagina/Ficha3.png';" onmouseout="this.src='/sismedant/images/pagina/Ficha.png';" width="300px"/>  
             ...
             <a href="index.php/resultado/create">
...
<!--    <a href="#">
        ...
        <!--<br><b> <img src="/sismedant/images/foto_estudiante.jpg" width="50%">  </b><br>-->
    </center>
    </h4>
     Un sistema web moderno e innovador
     <br>para la recolección y estudio de las medidas básicas antropométicas.
</div>