...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_Maquinaria_Equipo) => array('view', 'id'=>$model->id_Maquinaria_Equipo),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_Maquinaria_Equipo)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TbMaquinariaEquipo::label(); ?> <?php echo CHtml::encode($model) ?></legend>
