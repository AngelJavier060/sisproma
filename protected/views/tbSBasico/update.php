...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_SBasico) => array('view', 'id'=>$model->id_SBasico),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_SBasico)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TbSBasico::label(); ?> <?php echo CHtml::encode($model) ?></legend>
