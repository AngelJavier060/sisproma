...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_Produccion) => array('view', 'id'=>$model->id_Produccion),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_Produccion)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TbProduccion::label(); ?> <?php echo CHtml::encode($model) ?></legend>
